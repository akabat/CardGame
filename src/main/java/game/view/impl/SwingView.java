...
public class SwingView implements IView {
    ...
    JButton btnAddPlayer, btnDealCards, btnFindWinner;
    JTextArea textArea;
    ...
    public void showPlayerName(int playerIndex, String playerName) {
        appendText( String.format("[%1$d][%2$s]", playerIndex, playerName) );
    }

    @Override
    public void showCardForPlayer(int playerIndex, String playerName, String cardRank, String cardSuit) {
        appendText(String.format("[%1$s][%2$s:%3$s]", playerName, cardRank, cardSuit) );
    }

    @Override
    public void showWinner(String winnerName) {
        appendText(String.format("Winner!%s%n", winnerName) );
    }

    @Override
    public void showFaceDownCardForPlayer(int playerIndex, String name) {
        appendText(String.format("[%s][][]", name) );
    }
